...
class BlogApiControllerTest {
    ...
    @Autowired
    // ObjectMapper :   자바 객체를 JSON 데이터로 변환하는 직렬화
    //                  또는 반대로 JSON 데이터를 자바에서 사용하기 위해 자바 객체로 변환하는 역직렬화 할 때 사용한다.
    ...
    public void addArticle() throws Exception{
        ...
        // writeValueAsString : 객체 JSON으로 직렬화
        final String requestBody = objectMapper.writeValueAsString(userRequest);

        // when
        // MockMvc : 설정한 내용을 바탕으로 요청 전송
